...
// WARNING:
//
// Don't enable the global body-parser middleware.
// Just enable it on a case-by-case basis for the routes that need it.
//
// app.use(jsonBody);

//
// An example HTTP POST route that makes use of the body-parser middleware.
//
app.post("/api/route-with-body-parser", jsonBody, (req, res) => {

    console.log(`Made request with JSON body:`);
...
// This route does not make use of the body-parser middleware.
//
